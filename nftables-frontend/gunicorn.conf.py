...
def on_starting(server):
    ...
    # Usa o mesmo Python do Gunicorn para garantir /usr/local/bin e site-packages corretos
...
def on_exit(server):
    """Encerra o processo do parser com elegância ao sair."""
    global _parser_proc
